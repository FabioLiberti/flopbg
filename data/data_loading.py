...
def load_brain_tumor_data():
    """
    Carica il dataset Brain Tumor.
    """
    data_dir = os.path.join(parent_dir, 'data', 'Brain_Tumor')
    image_size = (224, 224)

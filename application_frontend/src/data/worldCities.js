const WORLD_CITIES = [
  ...
  // Italy - Mountain cities
  { city: 'Aosta', latitude: 45.7375, longitude: 7.3154, region: 'italy' },
  { city: 'Bolzano', latitude: 46.4983, longitude: 11.3548, region: 'italy' },
  { city: 'Trento', latitude: 46.0748, longitude: 11.1217, region: 'italy' },
  { city: 'Belluno', latitude: 46.1423, longitude: 12.2170, region: 'italy' },
  { city: 'Sondrio', latitude: 46.1699, longitude: 9.8727, region: 'italy' },
  { city: "L'Aquila", latitude: 42.3498, longitude: 13.3995, region: 'italy' },
  { city: 'Potenza', latitude: 40.6404, longitude: 15.8056, region: 'italy' },
  { city: 'Campobasso', latitude: 41.5604, longitude: 14.6684, region: 'italy' },
  { city: 'Avellino', latitude: 40.9148, longitude: 14.7906, region: 'italy' },
  { city: 'Rieti', latitude: 42.4025, longitude: 12.8584, region: 'italy' },
  { city: 'Isernia', latitude: 41.5960, longitude: 14.2330, region: 'italy' },
  { city: 'Nuoro', latitude: 40.3211, longitude: 9.3313, region: 'italy' },
  // Europe (non-Italy)
